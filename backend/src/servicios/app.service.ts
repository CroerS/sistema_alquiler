...
async  ContratoPorVencer(lista:any):Promise<Buffer>{
    const pdfBuffer:Buffer = await new Promise(resolve =>{
        //Creacion del document
        const doc= new PDFDocument({
            size:"LETTER",
        ...
        const table2 = {
          headers: [
            // { label:"Cod. Contrato", property: 'id_contrato',headerColor:"#000000",backgroundColor:'red',align:"center",width: 60, renderer: null },
            { label:"Numero de Contrato", property: 'id', headerColor:"#1c5e8a",headerOpacity:1,columnColor:'#FFFFFF',align:"center",width: 60, renderer: null },
            { label:"Fecha de Inicio", property: 'fechainicio',headerAlign:'center',headerColor:"#1c5e8a",headerOpacity:1, width: 50 , renderer: null }, 
            { label:"Fecha Fin", property: 'fechafin',headerColor:"#1c5e8a",headerOpacity:1,align:"center", width: 70, renderer: null }, 
            { label:"Estado del Contrato", property: 'estado', align:"center",headerColor:"#1c5e8a",headerOpacity:1, width: 60, renderer: null },
            { label:"Mes de Adelanto", property: 'mesesadelanto',headerColor:"#1c5e8a",headerOpacity:1,align:"center", width: 60, renderer: null },  
            { label:"Adelantado", property: 'pagoadelanto',headerAlign:'center',headerColor:"#1c5e8a",headerOpacity:1,align:"right", width: 50, renderer: (value:any, indexColumn:any, indexRow:any, row:any) => { return `Bs ${Number(value).toFixed(2)}` } },
            { label:"Inquilino", property: 'nombre_inquilino', align:"center",headerColor:"#1c5e8a",headerOpacity:1, width: 120, renderer: null }, 
            { label:"Numero de Cuarto", property: 'id_cuarto', align:"center",headerColor:"#1c5e8a",headerOpacity:1, width: 50, renderer: null }, 
        ],
          datas: lista 
        };
...
async  CuartoSolicitado(lista:any):Promise<Buffer>{
    const pdfBuffer:Buffer = await new Promise(resolve =>{
        //Creacion del document
        const doc= new PDFDocument({
            size:"LETTER",
        ...
        const table2 = {
          headers: [
            // { label:"Cod. Contrato", property: 'id_contrato',headerColor:"#000000",backgroundColor:'red',align:"center",width: 60, renderer: null },
            { label:"Numero de Cuarto", property: 'id_cuarto', headerColor:"#1c5e8a",headerOpacity:1,columnColor:'#FFFFFF',align:"center",width: 254, renderer: null },
            { label:"Cantidad de Cuartos", property: 'cantidad_contratos',headerColor:"#1c5e8a",headerOpacity:1,align:"center", width: 254, renderer: null },  
        ],
          datas: lista 
        };
